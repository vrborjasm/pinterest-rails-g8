...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { description: @pin.description, name: @pin.name, photo: @pin.photo } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { description: @pin.description, name: @pin.name, photo: @pin.photo } }
